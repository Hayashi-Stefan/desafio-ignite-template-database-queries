...
export class migration1616108470200 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    //Desafio
    await queryRunner.query(
      'CREATE TABLE "genres" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c9b16b62917b5595af982d66337" PRIMARY KEY ("id"))'
    );
    await queryRunner.query(
      'CREATE TABLE "orders" ("usersId" uuid NOT NULL, "gamesId" uuid NOT NULL, "value" INTEGER NOT NULL, CONSTRAINT "PK_cd4067d574477fd5c7693bc7872" PRIMARY KEY ("usersId", "gamesId"))'
    );
    //Fim
    await queryRunner.query(
    ...
    //Desafio
    await queryRunner.query(
      'ALTER TABLE "orders" ADD CONSTRAINT "FK_934b0d8f9d0084c97d3876ad48g" FOREIGN KEY ("gamesId") REFERENCES "games"("id") ON DELETE CASCADE ON UPDATE NO ACTION'
    );
    await queryRunner.query(
      'ALTER TABLE "orders" ADD CONSTRAINT "FK_934b0d8f9d0084c97d6889ad61g" FOREIGN KEY ("usersId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION'
    );
    //Fim
  }
